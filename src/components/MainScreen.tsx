...
export default function MainScreen() {
    return (
        ...
        //         <img src={bgItemsPc} alt="" className="hidden l:block absolute z-[20] max-w-[1200px] top-[0] right-0" />
        //         {/* <img src={bgItemsPc} alt="" className="hidden l:block absolute z-[20] max-w-[1200px] top-[0] left-[25%] xl:left-[35%] uw:left-[45%]" /> */}
        ...
        //     </div>
        // </section>
        <div className="relative w-full overflow-y-hidden overflow-x-hidden pt-[64px] bg-[#F3F4F5] h-[653px] l:h-[844px]">
            <img src={bgItemsPc} alt="" className="hidden l:block absolute z-[20] max-w-[1200px] top-[-50px] right-[-110px] scale-75 xl:right-[-140px] xl:scale-[85%]" />
            {/* <img src={bgItemsPc} alt="" className="hidden l:block absolute z-[20] max-w-[1200px] top-[0] left-[25%] xl:left-[35%] uw:left-[45%]" /> */}
            <section className="main-screen bevealed-bottom relative overflow-hidden w-full  h-[594px] l:h-[780px]">
                <img src={mainBg} alt="" className="absolute w-full z-[1] xm:h-full" />
                <div className="max-w-[1200px] h-full max-h-[455px] w-full mx-auto z-[10]">
                    <div className="flex flex-col relative h-full justify-between mt-[25px] px-[20px] l:mt-[66px]">
                        <div>
                            <img src={bgItemsMobile} alt="" className="absolute object-cover top-[20px] left-[-50px] min-w-[500px] max-w-[600px] w-full z-[-1] l:hidden" />
                            <h1 className="font-black text-[34px] l:text-[64px] text-[#2D2D2D]">
                                Изучайте язык так,
                                <br /> как удобно Вам!
                            </h1>
