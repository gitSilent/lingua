...
export default function MainScreen() {
    return (
        <div className="relative w-full h-full pt-[64px] max-h-[594px] bg-[#F3F4F5] l:max-h-[775px]">
            <img src={bgItemsPc} alt="" className="hidden l:block absolute z-[20] max-w-[1200px] top-[0] left-[25%] xl:left-[35%] uw:left-[45%]" />
            <section className="main-screen bevealed-bottom relative overflow-hidden w-full h-full">
