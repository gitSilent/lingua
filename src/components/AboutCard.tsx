...
export default function AboutCard({title, desc,bgChar}:IAboutCard) {
    return (
        <div className="relative overflow-hidden min-w-[285px] max-w-[335px] h-fit p-[20px] bg-[#F3F4F5] rounded-[12px]">
            <h3 className="font-black text-[20px] text-[#2D2D2D] mb-[8px]">Никаких секретов</h3>
            <p className="font-medium text-[14px] text-[#787878]">
                Мы ничего не скрываем! Все самое важное о нас можно найти в наших социальных сетях и в блоге нашего руководителя. Не нашли ответы на свои вопросы? Тогда обращайся к нашим менеджерам и они развеют твои сомнения!
            </p>
